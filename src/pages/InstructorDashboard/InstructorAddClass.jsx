...
const InstructorAddClass = () => {
    ...
    const onSubmit = (data) => {
        ...
        axios.post('https://musical-melody-server-masum73.vercel.app/addclass', { ...data, instructor: user._id , price: parseFloat(data.price), availableSeats: parseFloat(data.availableSeats)  })
            .then(data => {
                // refetch()
                reset()
            })
