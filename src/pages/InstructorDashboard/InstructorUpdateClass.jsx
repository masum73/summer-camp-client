...
const InstructorUpdateClass = () => {
    ...
    console.log({id});
    useEffect(() => {
        axios.get(`https://musical-melody-server-nv59blkol-masum73.vercel.app/classes/${id}`)
            .then(data => {
                setCls(data.data)
    ...
    const onSubmit = (submitData) => {
        ...
        axios.patch(`https://musical-melody-server-nv59blkol-masum73.vercel.app/updateclass/${id}`, {...submitData})
            .then(data => {
                console.log(data);
                setCls(data.data)
            })
