...
const AdminManageClass = () => {
    ...
    const makeApproved = (id) => {
        axios.patch(`https://musical-melody-server.vercel.app/updateclass/${id}`, {status: "approved"})
            .then(data => {
                refetch()
            })
    }
    const makeDenied = (id) => {
        ...
        axios.patch(`https://musical-melody-server.vercel.app/updateclass/${id}`, {status: "denied", feedback: feedback})
            .then(data => {
                refetch()
            })
    }
